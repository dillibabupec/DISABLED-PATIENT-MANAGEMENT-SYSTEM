...
$patis_id=$_GET['pats_id'];
 ...
 mysqli_query ($conn,"DELETE FROM patiententry_audio_child where pat_id='$patis_id'");
...
$pats_id=$_REQUEST['pats_id'];
    ...
    $pats_id_enc=encrypt("$pats_id","viewchild");



  header("Location:profile_child_audio.php?pats_id=$pats_id_enc"); 	 
...
if($_GET['action']=='editprofile'){
 ...
 $getpatid=$_REQUEST['getpatid']; 
  ...
  header("Location:audio_child_edit.php?getpatid=$get_patid_enc"); 	 
	
}



if($_GET['action']=='startexam'){
 ...
 $patyid=$_REQUEST['patyid']; 
    ...
    $patyid_enc=encrypt("$patyid","startexamschild");



  header("Location:child_audio_exam.php?patyid=$patyid_enc"); 	 
...
if($_GET['action']=='recommend'){
 ...
 $patyids=$_REQUEST['patyid']; 
    ...
    $patyids_enc=encrypt("$patyids","recomchilds");



  header("Location:child_audio_recommend.php?patyid=$patyids_enc"); 	 
      ...
      <div class="row row-offcanvas row-offcanvas-right">
	   ...
	   <?php include 'sidenav.php'; ?>
        ...
        <div class="content-wrapper">
          <h1 class="page-title" id="titl">MERF Patient List (Audiology - Childrens)</h1>
          <div class="card">
            <div class="card-body">
                ...
                <div class="col-12">
                  <table class="table table-bordered " id="order-listing" class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
					  	...
					  	<?php
				      $i = 0;
                            $get_profile = mysqli_query($conn,"select * from patiententry_audio_child");
                               ...
                               $i++;
                                $pat_id = $profile_detail['pat_id'];
								  ...
								  $vj5 = $profile_detail['father_name']; 
								 	
								  $vj6 = $profile_detail['dob']; 
								 
                                  $newDate = date("d-m-Y", strtotime($vj6));
								  
								  $vj7 = $profile_detail['language']; 
								  $vj8 = $profile_detail['contact']; 
								  
								  $vj9 = $profile_detail['address']; 
								  $vj10 = $profile_detail['complaints']; 
                      ...
                      <tr>
                          ...
                          <td><?php echo $vj8  ;  ?></td>
						     <td>
                            <a class="btn btn-warning" href="patient_list_child.php?action=viewprofile&pats_id=<?php echo $pat_id; ?>" style="font-weight:bold;  color:#fff; margin-top: 22%; cursor:pointer;">View</a>
                          </td>
						    <td>
                            <a href="patient_list_child.php?action=editprofile&getpatid=<?php echo $pat_id;   ?>" class="btn btn-success" style="font-weight:bold; color:#fff; cursor:pointer; margin-top: 18%;">Edit</a>
                            <a class=""  onClick="delete_menu('patient_list_child.php?action=delete&pats_id=<?php echo $pat_id; ?>')" style="font-weight:bold;color:#800000; margin-left: 38%; cursor:pointer;">Delete</a>
                          </td>
						   <td>
                            <a href="patient_list_child.php?action=startexam&patyid=<?php echo  $pat_id ;  ?>" style="font-weight:bold;  color:#800000;padding-top: 17%;padding-left: 28%;  cursor:pointer;">Start</a>
							
							
							
							
							
							 <a href="patient_list_child.php?action=recommend&patyid=<?php echo  $pat_id ;  ?>" style="font-weight:bold;  color:#4b0082;padding-top: 17%;padding-left: 0%; float:left;  cursor:pointer;">Recommend</a>
...
swal({
  title: "Are you sure?",
  text: "Your will not be able to recover this after!",
  type: "warning",
