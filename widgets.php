            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="dashboardSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="dashboard/dashboard-2.html">Dashboard 2</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="layoutsSubmenu">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="layout/boxed_layout.html">Boxed</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="layout/rtl_layout.html">Rtl</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarLayoutsSubmenu">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="layout/sidebar-compact.html">Compact menu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="layout/sidebar-collapsed.html">Collapsed</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="layout/sidebar-hidden.html">Hidden</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="layout/sidebar-hidden-overlay.html">Hidden overlay</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="layout/sidebar-fixed.html">Fixed sidebar</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="layout/horizontal_menu.html">Horizontal menu</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="generalSubmenu">
                        <ul class="nav flex-column sub-menu">
                          ...
                          <li class="nav-item">
                              <a class="nav-link" href="samples/portfolio.html">
                                Portfolio
                              </a>
                          </li>
                          <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#ecommerceSubmenu" aria-expanded="false" aria-controls="collapseExample">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="uiBasicSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="ui-features/progress.html">Progress</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="uiAdvancedSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="ui-features/listify.html">Listify</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="uiNotificationsSubmenu">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="ui-features/notifications.html">Toast</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="ui-features/desktop-notification.html">Desktop notification</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="uiSliderSubmenu">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="ui-features/ion-range-slider.html">Ion range</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="ui-features/no-ui-slider.html">No-ui-slider</a>
                            </li>
                        </ul>
                    </div>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="iconsSubmenu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="icons/font-awesome-icons.html">Font awesome</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="icons/themify-icons.html">Themify</a>
                                </li>
                                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="chartsSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="charts/sparkline.html">Sparkline</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="charts/c3.html">C3</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tablesSubmenu">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="tables/basic-table.html">Basic</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="tables/bootstrap-table.html">Bootstrap Table</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="tables/data-tables.html">Data Table</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="formsSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="forms/form-wizard.html">Wizard</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="formsAdvancedSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="forms/form-picker.html">Form pickers</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="textEditorSubmenu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="forms/quill-editor.html">Quill</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="codeEditorSubmenu">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="forms/ace.html">Ace</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            ...
            <div class="col-3">
              <div class="card card-statistics">
                <div class="card-body">
                  <p class="highlight-text">
                    <i class="mdi mdi-trophy text-primary"></i>
                    $450.00
                  </p>
                  <p class="text-muted">
                    Income amounts
          ...
          <div class="row grid-margin">
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="bold-text text-success">7896</h4>
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="bold-text text-primary">5623</h4>
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="bold-text text-warning">1236</h4>
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="bold-text text-danger">$ 7832</h4>
          ...
          <div class="row grid-margin">
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card bg-primary card-circle-progress">
                      <div class="card-body">
                          <h5 class="card-title text-white">Customers</h5>
                          <p class="card-text">
                              Last 30 days
                          </p>
                          <div class="circle-progress" data-value="0.9" data-size="100" data-thickness="10" data-animation-start-value="1.0" data-reverse="true"></div>
                      </div>
                  </div>
              </div>
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card bg-warning card-circle-progress">
                      <div class="card-body">
                          <h5 class="card-title text-white">Customers</h5>
                          <p class="card-text">
                              Last 30 days
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card bg-success card-circle-progress">
                      <div class="card-body">
                          <h5 class="card-title text-white">Customers</h5>
                          <p class="card-text">
                              Last 30 days
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                  <div class="card bg-danger card-circle-progress">
                      <div class="card-body">
                          <h5 class="card-title text-white">Customers</h5>
                          <p class="card-text">
                              Last 30 days
          ...
          <div class="row grid-margin">
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h6 class="bold-text text-primary">7896</h6>
              ...
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h6 class="bold-text text-primary">7523</h6>
              ...
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h6 class="bold-text text-primary">6932</h6>
              ...
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h6 class="bold-text text-primary">$ 54123</h6>
              ...
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h6 class="bold-text text-primary">23658</h6>
              ...
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <h6 class="bold-text text-primary">8965</h6>
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div class="row">
                              <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-xs-12 mb-4 mb-lg-0">
                  ...
                  <div class="card" style="min-height:395px;">
                      <div class="card-body">
                          ...
                          <div class="text-center">
                              <img src="../images/faces/face5.jpg" class="rounded-circle" width="100" height="100" />
                          </div>
                          ...
                          <h5 class="text-center font-weight-bold txt-brand-color">Tom Swayer, <span class="text-muted">CEO/CO-FOUNDER</span></h5>
                      </div>
                  </div>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-4">
