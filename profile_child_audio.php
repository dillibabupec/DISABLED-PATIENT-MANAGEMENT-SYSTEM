...
function decrypt($string, $key) {
 ...
 $patsid = decrypt($encrypted, "viewchild");
		...
		<?php
				          $get_profile = mysqli_query($conn,"select * from patiententry_audio_child where pat_id='$patsid'");
                                while($profile_detail = mysqli_fetch_array($get_profile)) {
									  ...
									  $vjshan4 = $profile_detail['dob']; 
									   $vj4 = date("d-m-Y", strtotime($vjshan4));
									  ...
									  $vj19 = $profile_detail['nature_of_onset']; 
									 
									  $vj20 = $profile_detail['prob_change_first_notice']; 
									
									  $vj21 = $profile_detail['medi_atte_age']; 
									  $vj22 = $profile_detail['hear_screen']; 
									  
									  
									  $vj23 = $profile_detail['pre_natal']; 
									  ...
									  $vj57 = $profile_detail['respond_sound']; 
...
<?php
                            ...
                            $get_profileq = mysqli_query($conn,"select * from audio_child_recommendation where pat_id='$patsid'");
              ...
              <div class="col-lg-4 side-left">
                ...
                <div class="card mb-4">
				  ...
				  <div>
                    ...
                    <h2 class="card-title" style="float:right;">Pat_ID : <?php echo $vj1 ;?></h2>
					</div>
                    <img src="images/3.jpg" alt="" style="margin-left:31%;">
                    <p class="name"><?php echo $vj2   ; ?></p>
                    <p class="designation"><span style="text-transform:uppercase;"><?php echo $vj5   ; ?></span> / <?php echo $vj3   ; ?></p>
                    <a class="email" href="#"><?php echo $vj14 ; ?></a>
                    <a class="number" href="#"><?php echo $vj13   ; ?></a>
                  </div>
                </div>
                    ...
                    <div class="wrapper">
                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="profile-tab">
                          ...
                          <div>
						  <label id="lab">Date of Birth</label>
						  <p><?php echo $vj4  ;  ?></p>
						  </div>
						  <hr>
						  ...
						  <div class="row">
						  <div class="col-md-5">
						   <label id="lab">Father Name</label>
						  <p><?php echo $vj6  ;  ?></p>
						  </div>
						  
						  <div class="col-md-2">
						  <label id="lab">Age</label>
						  <p><?php echo $vj8  ;  ?></p>
						  </div>
						  
						  <div class="col-md-5">
						  <label id="lab">Occupation</label>
						  <p><?php echo $vj7  ;  ?></p>
						  </div>
						  ...
						  <div class="row">
						  <div class="col-md-5">
						   <label id="lab">Mother Name</label>
						  <p><?php echo $vj9  ;  ?></p>
						  </div>
...
<!-- casehistory row start -->
				    <h2 id="lab">Onset and Severity :<h2>
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Age at which the problem was noticed</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Who was the first one to notice ?</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">What was the nature of the onset of the problem ?</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Has the problem changed since it was first noticed ?</h4>
							   </div>
...
<!-- casehistory row start -->
				<h2 id="lab">Early Diagnosis and Suggestions :<h2>
				<br>
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Age at which medical attention was first sought ?</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Hearing Screening Done</h4>
							   </div>
...
<!-- casehistory row start -->
				<h2 id="tim">Birth History<h2><br>
				<h2 id="lab">Pre - natal History :<h2>
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger"> Pre - natal History :</h4>
							  </div>
				...
				<h2 id="lab"> Peri Natal :<h2>
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Length of Pregneancy</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Length of Labour</h4>
							   </div>
								...
								<?php if($vj25=='prolonged'){ ?>
								<span>
								 <div class="topic">
								<h4 class="bold-text text-danger">How Long ?</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Place of Delivery</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Delivery Type</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Complications During Labour	</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Birth Cry</h4>
							   </div>
								...
								<span>
								 <div class="topic">
								<h4 class="bold-text text-danger">How much Delay ?</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Birth Weight</h4>
							  </div>
							  
							  <p class="card-text"><?php echo $vj32 ;  ?> Kg</p>
							  </div>
							  </div>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Birth Color</h4>
							   </div>
...
<!-- casehistory row start -->
					<h2 id="lab">Post - natal History :<h2>
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger">Post - natal</h4>
							  </div>
				 ...
				 <h2 id="tim">Family History<h2>
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Consanguinity </h4>
							  </div>
					...
					<?php if($vj35=='yes'){ ?>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">If yes, What ?</h4>
							   </div>
 ...
 <h2 id="tim">Medical History<h2>
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <p class="card-text"><?php echo $vjn37  ;  ?></p>
							  </div>
							  </div>
							  </div>
						...
						<?php if(in_array("ear_discharge",$vj37)){ ?>
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger">Ear Discharge</h4>
							  </div>
						...
						<?php if(in_array("ear_pain",$vj37)){ ?>
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger">Ear Pain</h4>
							  </div>
						...
						<?php if(in_array("ear_blockage",$vj37)){ ?>
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger">Ear Blockage</h4>
							  </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Has the Child undergone any Surgeries ?	</h4>
							  </div>
...
<!-- casehistory row start -->
				<h2 id="tim">Developmental History<h2>
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Motor Milestones</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Head Control</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Turning Over</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Sitting Alone</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Crawling</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Stood Without Support</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger">Walked Without Support</h4>
							  </div>
...
<!-- casehistory row start -->
				<h2 id="tim">Speech & Language Development<h2>
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Babbling</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">First Word</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Two Word Utterance	</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Communication Through Gestures</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Sensory Development</h4>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Vision</h4>
							   </div>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="topic">
							  <h4 class="bold-text text-danger">Hearing</h4>
							  </div>
							  
							  <p class="card-text"><?php echo $vj56  ;  ?></p>
							  </div>
							  </div>
							  </div>
							  ...
							  <div class="card-body carbody">
							   ...
							   <div class="topic">
								<h4 class="bold-text text-danger">Does the child responds to name call ?</h4>
							   </div>
							   
								<p class="card-text "><?php echo $vj58  ;  ?></p>
...
<!-- casehistory row start -->
						...
						<div class="row">
							 ...
							 <div class="card-body carbody" >
							  ...
							  <div class="">
							  <h4 class="bold-text text-danger">Does the child responds to sounds ?</h4>
							  </div>
							  
							  <p class="card-text"><?php echo $vj57  ;  ?></p>
							  </div>
							  </div>
							  </div>
                    ...
                    <div class="wrapper">
                      ...
                      <div class="tab-content" id="myTabContent">
						...
						<?php
                            ...
                            $get_profileza = mysqli_query($conn,"select * from audio_child_behavioural where pat_id='$patsid'");
...
<?php
            ...
            $getss_profiled = mysqli_query($conn,"select * from audio_child_immitance_audio where pat_id='$patsid'");
...
?>
            ...
            $getss_profileqaq = mysqli_query($conn,"select * from audio_child_electrophysiologic where pat_id='$patsid'");
	...
	<?php
              ...
              $getss_profileqw = mysqli_query($conn,"select * from audio_child_provisional where pat_id='$patsid'");
            ...
            $getss_profilelq = mysqli_query($conn,"select * from audio_child_hear_trail where pat_id='$patsid'");
