...
function decrypt($string, $key) {
 ...
 $patyid = decrypt($encrypted, "recomchilds");
...
$url= basename($_SERVER['REQUEST_URI']);
 ...
 if($_POST['recommendation_submit']=='recommendation_submit') {
	  ...
	  $get_detq = mysqli_query($conn,"select * from audio_child_recommendation where pat_id='$patyid'");
 ...
 if($get_countsq==0){
      ...
      mysqli_query ($conn,"INSERT INTO audio_child_recommendation (`pat_id`,`pat_name`,`counselling`,`device`,`ent_review`,`follow_up`,`examined_on`) values ('$patyid','$vj1','$vj2','$vj3','$vj4','$vj5','$vj6')");
	 ...
	 echo "<script type='text/javascript'>window.location = 'patient_list_child.php'</script>";
	  ...
	  mysqli_query ($conn,"UPDATE audio_child_recommendation SET `pat_name`='$vj1',`counselling`='$vj2',`device`='$vj3',`ent_review`='$vj4',`follow_up`='$vj5',`examined_on`='$vj6' where `pat_id`='$patyid' ");
...
<head>
  ...
  <title>Audio Child Recommendation</title>
  <meta charset="utf-8">
...
<?php
                            ...
                            $get_profileq = mysqli_query($conn,"select * from audio_child_recommendation where pat_id='$patyid'");
