...
$url= basename($_SERVER['REQUEST_URI']);
 ...
 $get_det = mysqli_query($conn,"select * from audio_adult_behavioural where pat_id='$patyid'");
 ...
 if($_POST['immitancesubmit']=='immitancesubmit') {
	 ...
	 $get_dets = mysqli_query($conn,"select * from audio_adult_immitance_audio where pat_id='$patyid'");
 ...
 if($_POST['electrophysiologicsubmit']=='electrophysiologicsubmit') {
	  ...
	  $get_detp = mysqli_query($conn,"select * from audio_adult_electrophysiologic where pat_id='$patyid'");
 ...
 if($get_countsp==0){
      ...
      mysqli_query ($conn,"INSERT INTO audio_adult_electrophysiologic (`pat_id`,`pat_name`,`bera_find`,`bera_impress`,`oae_find`,`oae_impress`,`vemp_find`,`vemp_impress`,`cafp_find`,`cafp_impress`,`others_find`,`others_impress`,`examined_on`) values ('$patyid','$vj1','$vj6','$vj7','$vj8','$vj9','$vj10','$vj11','$vj12','$vj13','$vj14','$vj15','$vj16')");
	 ...
	 echo "<script type='text/javascript'>window.location = '$url'</script>";
	   ...
	   mysqli_query ($conn,"UPDATE audio_adult_electrophysiologic  SET `pat_name`='$vj1',`bera_find`='$vj6',`bera_impress`='$vj7',`oae_find`='$vj8',`oae_impress`='$vj9',`vemp_find`='$vj10',`vemp_impress`='$vj11',`cafp_find`='$vj12',`cafp_impress`='$vj13',`others_find`='$vj14',`others_impress`='$vj15',`examined_on`='$vj16' where `pat_id`='$patyid' ");
 ...
 if($_POST['provisional_diagnosis_submit']=='provisional_diagnosis_submit') {
	  ...
	  $get_detq = mysqli_query($conn,"select * from audio_adult_provisional where pat_id='$patyid'");
 ...
 if($get_countsq==0){
      ...
      mysqli_query ($conn,"INSERT INTO audio_adult_provisional (`pat_id`,`pat_name`,`provisional_diagnosis`,`examined_on`) values ('$patyid','$vj1','$vj6','$vj7')");
	 ...
	 echo "<script type='text/javascript'>window.location = '$url'</script>";
      ...
      mysqli_query ($conn,"UPDATE audio_adult_provisional SET `pat_name`='$vj1',`provisional_diagnosis`='$vj6',`examined_on`='$vj7' where `pat_id`='$patyid'");
...
$vj83 = $_POST['ques_aware_bl_res'];
	  ...
	  $get_detp = mysqli_query($conn,"select * from audio_adult_hear_trail where pat_id='$patyid'");
 $get_countsp=mysqli_num_rows($get_detp);
 //echo $get_count;
...
<?php
                            ...
                            $get_profile = mysqli_query($conn,"select * from audio_adult_behavioural where pat_id='$patyid'");
...
<?php
            ...
            $getss_profile = mysqli_query($conn,"select * from audio_adult_immitance_audio where pat_id='$patyid'");
...
<div id="electrophysiologic_pat_det" style="display:none;">
	...
	<?php
            ...
            $getss_profileq = mysqli_query($conn,"select * from audio_adult_electrophysiologic where pat_id='$patyid'");
...
<div id="provisional_diagnosis_pat_det" style="display:none;">
	...
	<?php
              ...
              $getss_profileqw = mysqli_query($conn,"select * from audio_adult_provisional where pat_id='$patyid'");
...
<?php
            ...
            $getss_profilel = mysqli_query($conn,"select * from audio_adult_hear_trail where pat_id='$patyid'");
