...
$pats_id=$_REQUEST['pats_id'];
  ...
  header("Location:profile_adult_audio.php?pats_id=$pats_id_enc"); 	 
...
if($_GET['action']=='editprofile'){
 ...
 $getpatid=$_REQUEST['getpatid']; 
  ...
  header("Location:audio_adult_edit.php?getpatid=$get_patid_enc"); 	 
...
if($_GET['action']=='startexam'){
 ...
 $patyid=$_REQUEST['patyid']; 
  ...
  header("Location:adult_audio_exam.php?patyid=$patyid_enc"); 	 
...
if($_GET['action']=='recommend'){
 ...
 $patyids=$_REQUEST['patyid']; 
  ...
  header("Location:adult_audio_recommend.php?patyid=$patyids_enc"); 	 
      ...
      <div class="row row-offcanvas row-offcanvas-right">
	   ...
	   <?php include 'sidenav.php'; ?>
        ...
        <div class="content-wrapper">
          <h1 class="page-title" id="titl">MERF Patient List (Audiology - Adult)</h1>
          <div class="card">
            <div class="card-body">
                ...
                <div class="col-12">
                  <table class="table table-bordered " id="order-listing" class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
					  	...
					  	<?php
				      $i = 0;
                            $get_profile = mysqli_query($conn,"select * from patiententry_audio_adult");
                      ...
                      <tr>
                          ...
                          <td><?php echo $vj8  ;  ?></td>
						     <td>
                            <a class="btn btn-warning" href="patient_list.php?action=viewprofile&pats_id=<?php echo $pat_id; ?>" style="font-weight:bold;  color:#fff; margin-top: 22%; cursor:pointer;">View</a>
                          </td>
						    <td>
                            <a href="patient_list.php?action=editprofile&getpatid=<?php echo $pat_id;   ?>" class="btn btn-success" style="font-weight:bold; color:#fff; cursor:pointer; margin-top: 18%;">Edit</a>
						   ...
						   <td>
                            <a href="patient_list.php?action=startexam&patyid=<?php echo  $pat_id ;  ?>" style="font-weight:bold;  color:#800000;padding-top: 17%;padding-left: 28%;  cursor:pointer;">Start</a>
							
							
						
							
							
							 <a href="patient_list.php?action=recommend&patyid=<?php echo  $pat_id ;  ?>" style="font-weight:bold;  color:#4b0082;padding-top: 17%;padding-left: 0%; float:left;  cursor:pointer;">Recommend</a>
